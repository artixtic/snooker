...
**Features:**
- ✨ Separate tax calculation for table and canteen items
- 💰 Optional tax toggle (15%)
...
| Category | Sessions | Amount (PKR) |
|----------|----------|--------------|
| 🎮 Snooker | 2 | 123.00 |
| 🎮 Table Tennis | 1 | 59.00 |
| 🛒 Canteen | - | 41.00 |
...
| Tax Source | Details | Amount (PKR) |
|------------|---------|--------------|
| 🎮 Snooker Tax | 1 of 2 sessions | 9.00 |
| 🛒 Canteen Tax | 1 sale with tax | 4.00 |
| **Total Taxes Collected** | - | **13.00** |
...
| Cash Sales | 236.00 |
| Expenses | 0.00 |
| **Expected Cash** | **246.00** |

**Actions:**
- `[🔒 Close Shift!]`

**Features:**
- ✅ Validates all tables are closed before allowing shift closure
- 📊 Game-based revenue breakdown with session counts
- 💰 Detailed tax information per game and canteen
- 💸 Expense tracking included in cash reconciliation
- 📈 Profit calculation (Sales - Expenses)
- 🎯 Cash discrepancy calculation (Closing Cash - Expected Cash)
...
| Metric | Value |
|--------|-------|
| Total Sales | PKR 1,250 |
| Total Taxes | PKR 187.50 |
| Sessions | 42 |

**Game-Based Breakdown:**

| Game | Sessions | Revenue (PKR) | Tax (PKR) |
|------|----------|---------------|-----------|
| 🎮 Snooker | 15 | 450 | 67.50 |
| 🎮 Table Tennis | 12 | 360 | 54.00 |
| 🎮 PlayStation | 8 | 240 | 36.00 |
| 🛒 Canteen | - | 200 | 30.00 |
...
- 📊 Game-specific revenue and tax breakdown
- 📈 Session count tracking per game
- 💰 Detailed tax information with session counts
...
| Product | Category | Price (PKR) | Stock | Status | Actions |
|---------|----------|-------------|-------|--------|---------|
| Coca Cola<br>SKU: DRK-001 | Drinks | 2.50 | 100 | ✅ | `[Edit]` `[Delete]` |
| Snickers<br>SKU: SNK-001 | Snacks | 3.00 | 5 | ⚠️ Low Stock | `[Edit]` `[Delete]` |
| Water Bottle<br>SKU: DRK-003 | Drinks | 1.50 | 143 | ✅ | `[Edit]` `[Delete]` |
...
- 💰 Price management
- 📱 Barcode support (USB scanner and camera)
